        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="rounded-md space-y-4">
            ...
            <div>
              ...
              <select
                className="block w-full px-3 py-3 border border-zinc-300 text-zinc-900 rounded-lg focus:outline-none focus:ring-brand focus:border-brand sm:text-sm"
                value={formData.role}
          ...
          <div className="text-center">
            <p className="text-sm text-zinc-600">
              ...
              <Link to="/login" className="font-bold text-black hover:text-brand transition-colors underline underline-offset-4">
                Sign in here
              </Link>
            </p>
          </div>
